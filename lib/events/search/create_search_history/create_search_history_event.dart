...
abstract class CreateSearchHistoryEvent {
  Future<void> sendCreateSearchHistoryEvent(SearchHistory newSearchHistory) async {
    try {
  ...
  Future<SearchHistory> _createSearchHistory(SearchHistory newSearchHistory) async {
